...
//        latitudeValueNetwork = (TextView) findViewById(R.id.latitudeValueNetwork);
    ...
    public void toggleGPSUpdates(View view) {
        ...
        if(button.getText().equals("Pause")) {
            ...
            if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(RouteActivity.this, "First enable LOCATION ACCESS in settings.", Toast.LENGTH_LONG).show();
                return;
            }
            locationManager.requestLocationUpdates(
                    LocationManager.GPS_PROVIDER, 60 * 1000, 0, locationListenerGPS);
        ...
        public void onLocationChanged(Location location) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(RouteActivity.this, "Best Provider update", Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        public void onLocationChanged(Location location) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(RouteActivity.this, "Network Provider update", Toast.LENGTH_SHORT).show();
                }
            });
        }
    ...
    private final LocationListener locationListenerGPS = new LocationListener() {
        public void onLocationChanged(Location location) {
            ...
            editor.putString("longitude", longitudeGPS + "");
            editor.putString("latitude", latitudeGPS + "");
            editor.commit();
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(RouteActivity.this, "GPS Provider update", Toast.LENGTH_SHORT).show();
                }
            });
        }
